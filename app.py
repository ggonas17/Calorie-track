    ...
    if request.method == 'POST':
        ...
        if edit_type == 'macros':
            ...
            if request.form.get('override_routine') == 'on':
                ...
                # Isto força a app a recalcular os macros desse dia porque estragamos a rotina. Win-win.
        ...
        conn.commit(); conn.close()
        # Chama de novo para atualizar as metas caso a gente tenha estragado ali no workout.
